 ...
 */
public class ContraintViolationExceptionProcessorSkipper implements SkipPolicy {

    private static final Logger logger = LoggerFactory.getLogger("ContraintViolationException");
