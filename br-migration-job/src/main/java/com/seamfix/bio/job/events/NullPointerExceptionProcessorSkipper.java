 ...
 */
public class NullPointerExceptionProcessorSkipper implements SkipPolicy {

    private static final Logger logger = LoggerFactory.getLogger("NullPointerException");
